...
% LastEditTime : 2023-11-26 22:36:53 +0800
% Github       : https://github.com/YanMing-lxb/
% FilePath     : \GUET_Thesis_LaTeX\main.tex
% Description  : Version 2.1 更新请关注 https://github.com/YanMing-lxb/GUET_Thesis_LaTeX
%  -----------------------------------------------------------------------
%
...
\addbibresource[location=local]{./References/reference.bib}                 % biblatex 宏包的参考文献数据源加载方式
...
% ------------------------------------------------------------------------------------------
    \thesisbibliography                                                    % 参考文献
% ------------------------------------------------------------------------------------------
    \thesisacknowledgement                                                 % 致谢
    \thesisaccomplish{./References/accomplish.bib}                         % 攻读专业硕士学位期间取得的成果
